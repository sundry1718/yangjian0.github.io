...
<div class="nyflqh">
    <div class="container">
        <div class="row nyflqhbox"> 
            ...
            <a href="[nav:link]" class="nyflqha {pboot:if('[nav:scode]'=='{sort:scode}' )} on {/pboot:if}"> 
                [nav:name]
                <div class="nyflqhadw"> <img src="{pboot:sitedomain}/style/images/sanjiaoxinglan.png" alt=""> </div>
            </a> 
            {/pboot:nav}
        </div>
    </div>
...
<div class="nyxwlb">
  <div class="container">
    <div class="row nyxwlbbox"> {pboot:list num=6} <a href="[list:link]" target="_blank" class="nygsxw_cta">
      <div class="nygsxw_ctaimg"> <img src="[list:ico]" alt="[list:title]"> </div>
      <div class="nygsxw_ctatxt">
        <div class="nygsxw_ctatxtbox">
          <div class="nygsxw_ctatxtbox_t">[list:title]</div>
          <div class="nygsxw_ctatxtbox_b">[list:description drophtml=1 dropblank=1 lencn=80]</div>
        </div>
      </div>
      <div class="nygsxw_ctasj">
        <div class="nygsxw_ctasjbox">
          <p>[list:date style="m-d"]</p>
          <span>[list:date style="Y"]</span> </div>
      </div>
      </a> {/pboot:list} </div>
    ...
    {pboot:if({page:rows}>0)}
      <div class="pagebar">
        <div class="pagination">
          <a class="page-item page-link" href="{page:pre}" title="上一页"><<</a>
          {page:numbar}
          <a class="page-item page-link" href="javascript:;" title="当前页/总页数">{page:current}/{page:count}</a>
          <a class="page-item page-link" href="{page:next}" title="下一页">>></a>
        </div>
      </div>	
    {else}
...
<?php return array (
  ...
  1 => 'D:/phpstudy_pro/WWW/pboot02.com/template/default/top.html',
  2 => 'D:/phpstudy_pro/WWW/pboot02.com/template/default/foot.html',
); ?>